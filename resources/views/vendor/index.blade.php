        ...
        <div class="row medium-padding120 bg-border-color">
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                           @foreach($code->posts()->orderBy('created_at','desc')->take(3)->get() as $c)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{ $c->featured }}" alt="{{ $c->title }}">
                                            </div>
                                            <h6 class="case-item__title"><a href="{{ route('post.single', [ 'slug' => $c->slug ]) }}">{{ $c->title }}</a></h6>
                                        </div>
                                </div> 
                           @endforeach
                        </div>
