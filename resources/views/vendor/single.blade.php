                ...
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img src="{{ asset($post->user->profile->avatar) }}" alt=" {{ $post->user->profile->about }}" style="height:120px;width:120px;border-radius:50%;">
                        </div>
                        ...
                        <div class="blog-details-author-content">
                            ...
                            <div class="socials">
                                ...
                                <a href="{{ $post->user->profile->youtube }}" class="social__item" target="_blank">
                                    <img src="{{ asset('app/svg/youtube.svg') }}" alt="twitter">
                                </a>
